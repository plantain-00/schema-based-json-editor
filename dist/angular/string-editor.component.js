...
var StringEditorComponent = (function () {
    ...
    StringEditorComponent.prototype.canPreviewImage = function () {
        return common.isImageUrl(this.value);
    };
    StringEditorComponent.prototype.canPreviewMarkdown = function () {
        return this.md && this.schema.format === "markdown";
    };
    StringEditorComponent.prototype.canPreviewCode = function () {
        return this.hljs && this.schema.format === "code";
    };
    StringEditorComponent.prototype.canPreview = function () {
        return this.value && (this.canPreviewImage() || this.canPreviewMarkdown() || this.canPreviewCode());
    };
    StringEditorComponent.prototype.getImageUrl = function () {
        return this.forceHttps ? common.replaceProtocal(this.value) : this.value;
    };
    StringEditorComponent.prototype.getMarkdown = function () {
        return this.md.render(this.value);
    };
    StringEditorComponent.prototype.getCode = function () {
