 ...
 */
import { createBlock as _createBlock, createCommentVNode as _createCommentVNode, createTextVNode as _createTextVNode, createVNode as _createVNode, Fragment as _Fragment, openBlock as _openBlock, renderList as _renderList, resolveComponent as _resolveComponent, toDisplayString as _toDisplayString } from 'vue'
// tslint:disable
/* eslint-disable */
...
export function anyEditorTemplateHtml(_ctx, _cache) {
  ...
  return (_openBlock(), _createBlock("div", { class: _ctx.className }, [
    _createVNode("label", {
      class: _ctx.theme.title
    }, [
      _createTextVNode(_toDisplayString(_ctx.titleToShow) + " ", 1 /* TEXT */),
      _createVNode("div", {
        class: _ctx.theme.buttonGroup,
        style: _ctx.buttonGroupStyle
      }, [
...
export function arrayEditorTemplateHtml(_ctx, _cache) {
  ...
  return (_openBlock(), _createBlock("div", { class: _ctx.className }, [
    _createVNode("h3", null, [
      ...
      _createVNode("div", {
        class: _ctx.theme.buttonGroup,
        style: _ctx.buttonGroupStyleString
      }, [
        _createVNode(_component_optional, {
          required: _ctx.required,
          value: _ctx.value,
        ...
        (_ctx.hasAddButton)
          ? (_openBlock(), _createBlock(_component_icon, {
              key: 1,
              onClick: _cache[3] || (_cache[3] = $event => (_ctx.addItem())),
              text: _ctx.icon.add,
              theme: _ctx.theme,
              icon: _ctx.icon
            }, null, 8 /* PROPS */, ["text", "theme", "icon"]))
    ...
    (_ctx.schema.enum)
      ? (_openBlock(), _createBlock("div", { key: 0 }, [
          (_ctx.schema.format === 'select2' && !_ctx.noSelect2)
            ? (_openBlock(), _createBlock(_component_select2, {
                ...
                multiple: true,
                onUpdate: _cache[5] || (_cache[5] = $event => (_ctx.onChangeSelect2($event)))
              }, null, 8 /* PROPS */, ["data", "value", "disabled"]))
            : (_openBlock(true), _createBlock(_Fragment, { key: 1 }, _renderList(_ctx.options, (option) => {
                return (_openBlock(), _createBlock("span", {
                  key: option.value,
                  class: _ctx.theme.checkbox
                }, [
      ...
      : (_openBlock(), _createBlock("div", {
          key: 1,
          class: _ctx.theme.card
        }, [
          (_ctx.showFilter)
            ? (_openBlock(), _createBlock("div", {
                key: 0,
                class: _ctx.theme.row
              }, [
                _createVNode("input", {
                  class: _ctx.theme.input,
                  onChange: _cache[6] || (_cache[6] = $event => (_ctx.onFilterChange($event))),
                  onKeyup: _cache[7] || (_cache[7] = $event => (_ctx.onFilterChange($event))),
                  value: _ctx.filter
                }, null, 42 /* CLASS, PROPS, HYDRATE_EVENTS */, ["value"])
              ], 2 /* CLASS */))
            : _createCommentVNode("v-if", true),
          (_openBlock(true), _createBlock(_Fragment, null, _renderList(_ctx.filteredValues, (item) => {
            return (_openBlock(), _createBlock("div", {
              key: (1 + item.i) * _ctx.renderSwitch,
              "data-index": item.i,
              class: _ctx.theme.rowContainer
            }, [
          ...
          (_ctx.schema.format === 'checkbox')
            ...
            : (_ctx.schema.format === 'select')
              ? (_openBlock(), _createBlock("select", {
                  key: 1,
                  class: _ctx.theme.select,
                  value: _ctx.value,
                  disabled: _ctx.isReadOnly,
                  onChange: _cache[4] || (_cache[4] = $event => (_ctx.onChange()))
                }, [
                  _createVNode("option", { value: true }, _toDisplayString(_ctx.locale.info.true), 1 /* TEXT */),
                  _createVNode("option", { value: false }, _toDisplayString(_ctx.locale.info.false), 1 /* TEXT */)
              ...
              : (_ctx.schema.format === 'select2')
                ? (_openBlock(), _createBlock(_component_select2, {
                    ...
                    value: _ctx.value,
                    disabled: _ctx.isReadOnly,
                    onUpdate: _cache[5] || (_cache[5] = $event => (_ctx.onChange()))
                  }, null, 8 /* PROPS */, ["data", "value", "disabled"]))
                : (_openBlock(), _createBlock(_Fragment, { key: 3 }, [
                    _createVNode("span", {
                      class: _ctx.theme.radiobox
                    }, [
                      _createVNode("label", null, [
                        _createVNode("input", {
                          type: "radio",
                    ...
                    _createVNode("span", {
                      ...
                      _createVNode("label", null, [
                        _createVNode("input", {
                          type: "radio",
                          onChange: _cache[7] || (_cache[7] = $event => (_ctx.onChange())),
                          checked: !_ctx.value,
                          disabled: _ctx.isReadOnly
                        }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["checked", "disabled"]),
  ...
  return (_openBlock(), _createBlock("div", { class: _ctx.className }, [
    ...
    (_ctx.useInput)
      ? (_openBlock(), _createBlock("input", {
          key: 0,
          class: _ctx.errorMessage ? _ctx.theme.errorInput : _ctx.theme.input,
          type: "number",
          onChange: _cache[3] || (_cache[3] = $event => (_ctx.onChange($event))),
    ...
    (_ctx.useSelect2Component)
      ? (_openBlock(), _createBlock(_component_select2, {
          ...
          value: _ctx.value,
          disabled: _ctx.isReadOnly,
          onUpdate: _cache[5] || (_cache[5] = $event => (_ctx.updateSelection($event)))
        }, null, 8 /* PROPS */, ["data", "value", "disabled"]))
      : _createCommentVNode("v-if", true),
    (_ctx.useSelectComponent)
      ? (_openBlock(), _createBlock("select", {
          ...
          value: _ctx.value,
          disabled: _ctx.isReadOnly,
          onChange: _cache[6] || (_cache[6] = $event => (_ctx.updateSelection(+$event.target.value)))
        }, [
      ...
      ? (_openBlock(), _createBlock("div", {
          ...
          (_ctx.showFilter)
            ? (_openBlock(), _createBlock("div", {
                ...
                _createVNode("input", {
                  class: _ctx.theme.input,
                  onChange: _cache[4] || (_cache[4] = $event => (_ctx.onFilterChange($event))),
                  onKeyup: _cache[5] || (_cache[5] = $event => (_ctx.onFilterChange($event))),
                  placeholder: _ctx.locale.info.search,
                  value: _ctx.filter
                }, null, 42 /* CLASS, PROPS, HYDRATE_EVENTS */, ["placeholder", "value"])
              ], 2 /* CLASS */))
            : _createCommentVNode("v-if", true),
          (_openBlock(true), _createBlock(_Fragment, null, _renderList(_ctx.filteredProperties, (p, i) => {
  ...
  return (_ctx.hasOptionalCheckbox)
    ? (_openBlock(), _createBlock("div", {
        ...
        _createVNode("label", null, [
          _createVNode("input", {
            type: "checkbox",
            onChange: _cache[1] || (_cache[1] = $event => (_ctx.$emit('toggleOptional'))),
  ...
  return (_openBlock(), _createBlock("div", { class: _ctx.className }, [
    _createVNode("label", {
      ...
      _createVNode("div", {
        ...
        (_ctx.canPreview)
          ? (_openBlock(), _createBlock(_component_icon, {
              key: 1,
              onClick: _cache[3] || (_cache[3] = $event => (_ctx.collapseOrExpand())),
              text: _ctx.collapsed ? _ctx.icon.expand : _ctx.icon.collapse,
              theme: _ctx.theme,
              icon: _ctx.icon
            }, null, 8 /* PROPS */, ["text", "theme", "icon"]))
    ...
    (_ctx.useTextArea && _ctx.monacoEditor && _ctx.schema.format === 'json')
      ? (_openBlock(), _createBlock("div", {
          key: 1,
          ref: "monacoEditor",
          style: { height: '400px', width: '90%', display: _ctx.collapsed ? 'none' : undefined }
        }, null, 4 /* STYLE */))
      : _createCommentVNode("v-if", true),
    (_ctx.useTextArea && (!_ctx.monacoEditor || _ctx.schema.format !== 'json'))
      ? (_openBlock(), _createBlock("textarea", {
          key: 2,
          class: _ctx.errorMessage ? _ctx.theme.errorTextarea : _ctx.theme.textarea,
          onChange: _cache[5] || (_cache[5] = $event => (_ctx.onChange($event))),
          onKeyup: _cache[6] || (_cache[6] = $event => (_ctx.onChange($event))),
          rows: "10",
          readOnly: _ctx.isReadOnly,
          disabled: _ctx.isReadOnly
    ...
    (_ctx.useInput)
      ? (_openBlock(), _createBlock("input", {
          ...
          onChange: _cache[7] || (_cache[7] = $event => (_ctx.onChange($event))),
          onKeyup: _cache[8] || (_cache[8] = $event => (_ctx.onChange($event))),
          value: _ctx.value,
          readOnly: _ctx.isReadOnly,
          disabled: _ctx.isReadOnly
    ...
    (_ctx.useSelect2Component)
      ? (_openBlock(), _createBlock(_component_select2, {
          ...
          value: _ctx.value,
          disabled: _ctx.isReadOnly,
          onUpdate: _cache[9] || (_cache[9] = $event => (_ctx.updateSelection($event)))
        }, null, 8 /* PROPS */, ["data", "value", "disabled"]))
      : _createCommentVNode("v-if", true),
    (_ctx.useSelectComponent)
      ? (_openBlock(), _createBlock("select", {
          ...
          value: _ctx.value,
          disabled: _ctx.isReadOnly,
          onChange: _cache[10] || (_cache[10] = $event => (_ctx.updateSelection($event.target.value)))
        }, [
          (_openBlock(true), _createBlock(_Fragment, null, _renderList(_ctx.options, (option) => {
            return (_openBlock(), _createBlock("option", {
              key: option.value,
      ...
      : _createCommentVNode("v-if", true),
    (_ctx.useRadioBoxComponent)
      ? (_openBlock(), _createBlock("div", { key: 6 }, [
          (_openBlock(true), _createBlock(_Fragment, null, _renderList(_ctx.options, (option) => {
            return (_openBlock(), _createBlock("span", {
              key: option.value,
              class: _ctx.theme.radiobox
    ...
    (_ctx.willPreviewCode)
      ? (_openBlock(), _createBlock("pre", { key: 10 }, [
          _createVNode("code", { innerHTML: _ctx.getCode }, null, 8 /* PROPS */, ["innerHTML"])
        ]))
      : _createCommentVNode("v-if", true),
    _createVNode(_component_description, {
      theme: _ctx.theme,
