...
import { ValidityValue, ValueType } from "../../dist/aot/angular";
...
@Component({
    ...
    template: `
    <div>
        <a href="https://github.com/plantain-00/schema-based-json-editor/tree/master/demo/aot/index.ts" target="_blank">the source code of the demo</a>
        <br/>
